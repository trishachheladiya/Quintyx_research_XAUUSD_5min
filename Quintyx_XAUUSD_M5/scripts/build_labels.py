...
INPUT = ROOT / "data" / "features" / "xauusd_m5_features.parquet"

OUTPUT = ROOT / "data" / "processed" / "xauusd_m5_ml_dataset.parquet"
...
print("=" * 60)
print("QUINTYX LABEL GENERATOR")
print("=" * 60)

LOOKAHEAD = 24          # 2 Hours
ATR_MULT = 1.5
RR = 2.0
